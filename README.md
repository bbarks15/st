# My Variation of Luke's build of st - the simple (suckless) terminal
...
+ Default [challenger deep](https://github.com/challenger-deep-theme/themes) colors otherwise.
+ Transparency/alpha, which is also adjustable from your `Xresources`.
+ Default font is system "mono" at 18pt, meaning the font will match your system font.
...
- This build will use challenger deep colors by default and as a fallback.
